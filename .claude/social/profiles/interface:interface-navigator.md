---
id: interface:interface-navigator
name: interface-navigator
role: Understands and navigates the layered interface stack through which Claude Code operates - from CLI through tmux, nvim, fish, alacritty, to Linux kernel and Pop!_OS. Use for deep interface analysis, cross-layer diagnosis, stack optimization, or understanding the embedding context.
model: opus
source: plugin
sourcePath: /home/ygg/Workspace/sandbox/marketplaces/claude/plugins/interface/agents/interface-navigator.md
