...
id: qa-engineer
name: qa-engineer
role: QA engineer for manual testing, bug reproduction, test planning, and quality validation. Use for finding edge cases, creating test checklists, and validating TUI interactions.
model: sonnet
source: project
sourcePath: /home/ygg/Workspace/sandbox/marketplaces/claude/.claude/agents/qa-engineer.md
