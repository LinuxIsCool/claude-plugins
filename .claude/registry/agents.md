...
| **chief-of-staff** | Operations coordination, task breakdown, progress tracking | haiku | Read, Write, Edit, Glob, Grep |
...
| **sonnet** | 28 | Standard operations, domain expertise |
| **haiku** | 4 | Lightweight tasks, fast responses (chronologist, chief-of-staff, vault-health, researcher) |
